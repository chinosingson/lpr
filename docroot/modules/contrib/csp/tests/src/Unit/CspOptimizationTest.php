...
class CspOptimizationTest extends UnitTestCase {
  ...
  public function testReduceSourceListWithNone() {
    ...
    $this->expectDeprecation("'none' overriding other sources is deprecated in csp:8.x-1.30 and behaviour will change in csp:2.0.0. See https://www.drupal.org/node/3411477");
